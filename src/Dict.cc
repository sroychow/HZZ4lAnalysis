...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::vhtm::Event*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("vhtm::Event", ::vhtm::Event::Class_Version(), "PhysicsObjects.h", 54,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::vhtm::GenEvent*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("vhtm::GenEvent", ::vhtm::GenEvent::Class_Version(), "PhysicsObjects.h", 91,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::vhtm::Electron*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("vhtm::Electron", ::vhtm::Electron::Class_Version(), "PhysicsObjects.h", 103,
